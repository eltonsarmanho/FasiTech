...
\section{Quando devo enviar as ATIVIDADES CURRICULARES COMPLEMENTARES (ACC)?}
\begin{itemize}
    \item As ACCs devem ser enviadas a partir do terceiro semestre.
    \item Use o formulário de ACC disponível na web page da FASI (\url{https://fasitech.com.br/FormACC}).
    \item O aluno não precisa estar matriculado em uma disciplina para condicionar o envio do documento.
\end{itemize}
\section{Onde posso encontrar o quadro de ofertas de disciplinas do curso?}
O quadro de ofertas de disciplinas do curso pode ser encontrado no site da Faculdade, na seção de "Ofertas".
O link direto é: \url{https://www.campuscameta.ufpa.br/index.php/sistemas-de-informacao?showall=&start=4}.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Atenção: O aluno não precisa estar matriculado obrigatoriamente em uma disciplina para condicionar o envio do documento. 
    \end{itemize}   
