...
\begin{frame}{Formulários Acadêmicos de ACC}
  \begin{center}
    % Substituir pelo caminho correto da imagem do formulário de ACC
     \includegraphics[width=0.65\textwidth]{formulario_acc.png}
    %\emph{(Inserir aqui figura ilustrando o formulário de ACC no FasiTech)}%
  \end{center} 
\end{frame}
...
\begin{frame}{Formulários Acadêmicos de ACC}
  \begin{center}
    % Substituir pelo caminho correto da imagem do formulário de ACC
     \includegraphics[width=0.45\textwidth]{resposta_acc.jpeg}
    %\emph{(Inserir aqui figura ilustrando o formulário de ACC no FasiTech)}%
  \end{center} 
\end{frame}

\begin{frame}{Formulário Socioeconômico Social}
 \begin{itemize}
    \item Coleta de dados estruturados para análise e planejamento de políticas de apoio estudantil.
    \item Integração com planilhas para facilitar a análise estatística.
  \end{itemize}
  \vfill
  \begin{center}
    % Substituir pelo caminho correto da imagem do formulário socioeconômico
     \includegraphics[width=0.5\textwidth]{formulario_socioeconomico.png}
    %\emph{(Inserir aqui figura ilustrando o formulário socioeconômico no FasiTech)}%
  \end{center}
\end{frame}
...
\begin{frame}{Diretor Virtual (RAG sobre PPC)}
  \begin{center}
    % Substituir pelo caminho correto da imagem do Diretor Virtual
    % Deixar a imagem perfeitamente fit em toda area do slide
    \includegraphics[width=1\textwidth,height=1.5\textheight,keepaspectratio]{diretor_virtual.png}
  \end{center}
\end{frame}
