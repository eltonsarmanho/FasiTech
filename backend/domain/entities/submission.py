...
class EstagioSubmissionEntity(BaseModel):
    nome: str
    matricula: str
    email: EmailStr
    turma: str
...
class RequerimentoTccEntity(BaseModel):
    nome_aluno: str
    matricula: str
    email: EmailStr
...
class SocialSubmissionEntity(BaseModel):
    matricula: str
...
class PlanoEnsinoEntity(BaseModel):
    professor: str
    disciplina: str
...
class ProjetosEntity(BaseModel):
    docente: str
    parecerista1: str
    parecerista2: str
    nome_projeto: str
...
class AvaliacaoGestaoEntity(BaseModel):
...
class EmissaoDocumentosEntity(BaseModel):
    nome: str
    matricula: str
    email: EmailStr
    tipo_documento: str  # "conclusao" | "matricula_ativa"
    polo: Optional[str] = None
