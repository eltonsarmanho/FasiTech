...
from backend.infrastructure.database.engine import get_db_session, engine
from backend.infrastructure.database.models import SocialSubmission
from backend.infrastructure.database.schemas_legacy import (
    DadoSocial, 
